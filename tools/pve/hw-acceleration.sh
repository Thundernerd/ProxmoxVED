...
# Repo: https://github.com/Thundernerd/ProxmoxVED
#
# Usage: bash -c "$(wget -qLO - https://github.com/Thundernerd/ProxmoxVED/raw/main/misc/hw-acceleration.sh)"
#
# Requires:
#   - Proxmox VE 8.1+
...
# https://github.com/Thundernerd/ProxmoxVED
...
source <(wget -qO- https://github.com/Thundernerd/ProxmoxVED/raw/main/tools/pve/gpu-nvidia.func)
source <(wget -qO- https://github.com/Thundernerd/ProxmoxVED/raw/main/tools/pve/gpu-intel.func)
source <(wget -qO- https://github.com/Thundernerd/ProxmoxVED/raw/main/tools/pve/gpu-amd.func)
